...
@section('body')
    <header class="text-center py-10">
        ...
        <div class="sm:flex sm:justify-center sm:items-center">
            <img class="h-16 sm:h-24 flex sm:flex-none items-center mx-auto sm:mx-0" src="/assets/images/logo-harbor.png" alt="{{ $page->siteName }} Logo">
        ...
        <div class="mt-8">
            <div class="md:flex md:justify-center my-10">
                ...
                <a href="https://github.com/mehrancodes/laravel-harbor" target="_blank" title="Source Code" class="block mt-6 sm:mt-0 sm:inline-block border-2 border-gray-900 text-gray-900 text-lg font-bold rounded-lg md:mr-4 py-3 px-8">Source Code</a>
            </div>
        </div>
    </header>
        ...
        <div>
            ...
            <div class="flex md:justify-end items-center gap-4 mt-8 md:mt-3">
                ...
                <div class="font-medium dark:text-white">
                    ...
                    <div class="text-sm text-gray-400 dark:text-gray-400">Harbor Creator</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="px-4 pt-12 pb-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pb-20 lg:pt-16">
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                ...
                Harbor Works: A Quick and Easy Guide!
            </h2>
            <div>
        ...
        <div class="grid max-w-2xl mx-auto">
            ...
            <div class="flex">
                ...
                <div class="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
                    ...
                    <div>
                        <p class="text-xl font-semibold sm:text-base">Run Harbor</p>
                        <p class="text-sm text-gray-700">
            ...
            <div class="grid grid-cols-1 gap-16 row-gap-8 lg:grid-cols-2">
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-gray-700">
                            Absolutely! Harbor is versatile and supports the automated deployment of various project types, including Laravel applications and Nuxt.js with support for SSR.<br />
                            <br />
                    ...
                    <div>
                        ...
                        <p class="text-gray-700">
                            Certainly! Harbor allows you to define custom commands to run after the deployment, as well as enabling task scheduler for your Laravel projects.<br />
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-gray-700">
                            While Harbor is primarily used with GitHub Actions, it can be utilized with any Git provider that is supported by Laravel Forge.<br />
                            <br />
                    ...
                    <div>
                        ...
                        <p class="text-gray-700">
                            Absolutely! Harbor is your go-to for setting up quick project demos. Show off your features or share your work hassle-free.<br />
                            <br />
