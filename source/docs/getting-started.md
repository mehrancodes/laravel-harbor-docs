...
3. **Configured Secrets**: `FORGE_TOKEN`, `FORGE_SERVER`, and `FORGE_ORGANIZATION` should be set up in your GitHub repository settings. See [Prerequisites](/docs/prerequisites) and [Harbor Configuration](/docs/configuration#forge-organization). Upgrading from v1? See [Upgrading to v2](/docs/upgrade-to-v2).
